...
public class BoardMgrController extends DefaultController{
	...
	*/
	...
	public ModelAndView getList(@ModelAttribute TB_PDBORDXM  tb_pdbordxm, Model model) throws Exception {
	...
	*/
	...
	public ModelAndView getNotice(@ModelAttribute TB_PDBORDXM  tb_pdbordxm, Model model) throws Exception {
	...
	*/
	...
	public ModelAndView getBoard(@ModelAttribute TB_PDBORDXM  tb_pdbordxm, Model model) throws Exception {
