...
public class CommunityRespController extends DefaultController{
	...
	*/
	...
	public ModelAndView preview(@ModelAttribute TB_PDBORDXM tb_pdbordxm, Model model) throws Exception {		
		...
		qna.setRowCnt(5);
		List<TB_PDBORDXM> qnas = (List<TB_PDBORDXM>) boardService.getPaginatedObjectList(qna);
		...
		review.setRowCnt(5);
		List<TB_PDBORDXM> reviews = (List<TB_PDBORDXM>) boardService.getPaginatedObjectList(review);
